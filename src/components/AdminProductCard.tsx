  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-3 text-center flex flex-col justify-center items-center max-w-sm mt-3">
      ...
      <div className="flex gap-2 pt-4 justify-center items-center">
          ...
          <button className="text-white bg-primario hover:bg-primario/80 rounded-2xl py-2 px-4 cursor-pointer text-sm min-w-[100px] text-center transition-colors duration-200" onClick={() => deleteProduct(product.id)}>Eliminar</button>
      </div>
    </div>
  );
};
